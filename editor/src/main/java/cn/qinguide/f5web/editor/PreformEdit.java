package cn.qinguide.f5web.editor;
/*
...
public class PreformEdit {
    ...
    public PreformEdit(EditText editText) {
    ...
    private void onEditableChanged(Editable s) {
        if (onEditChangedListener != null)
            onEditChangedListener.onEditableChanged(s);
    }

    private void onTextChanged(Editable s) {
        if (onEditChangedListener != null)
            onEditChangedListener.onTextChanged(s);
    }
    ...
    public interface onEditChangedListener {
        void onEditableChanged(Editable editable);
